%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Präambel einer Vorlage für akademische Arbeiten
%% bezogen auf die Gestaltungsrichtlinien der Medienwissenschaft
%% an der Universität Regensburg
%% 
%% Viel Vergnügen beim Verwenden und Ändern der Einstellungen,
%% viel Erfolg bei der Arbeit!
%% Juli 2008, Christoph Mandl und Christoph Pfeiffer
%% 
...
%% eigenes format für längere zitate
\newenvironment{zitat}{%
  %\list{}{\footnotesize\singlespacing{\leftmargin=13pt}}\item\relax}{\endlist}
  \begin{spacing}{1.1}\list{}{%
  \small{\leftmargin=13pt}%
  }\item\relax}{\endlist\end{spacing}}
  
%% umgebung um rand links und rechts variabel einzuziehen  
\def\randeinzug#1#2{\list{}{\rightmargin#2\leftmargin#1}\item[]}
\let\endrandeinzug=\endlist  
  
%% oder das hier umformatieren  
...
\usepackage[scaled=1.03,osf]{xagaramon}% Adobe Garamond Expert oldstylenums
\renewcommand{\rmdefault}{pegj}
\usepackage[small,euler-digits]{eulervm}

%%% Adobe Springer Myriad
\renewcommand{\sfdefault}{fmy}% S_Myriad
